...
model = Sequential()
model.add(SimpleRNN(95, batch_input_shape=(None, 17, 1), unroll=True))
model.add(Dropout(0.3556546957534775))
model.add(Dense(2))
...
model.fit(train_x,train_y,validation_data= (test_x,test_y),verbose=2,callbacks=[history],batch_size=42,epochs=69)

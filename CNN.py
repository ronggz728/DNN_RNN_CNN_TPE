...
model.fit(train_x,train_y,validation_data= (test_x,test_y),verbose=2,callbacks=[history],epochs=100)
...
input_1 = np.load('F://第三篇//样本处理//CNN//2倍//input_1.npy')
input_2 = np.load('F://第三篇//样本处理//CNN//2倍//input_2.npy')
input_3 = np.load('F://第三篇//样本处理//CNN//2倍//input_3.npy')
input_4 = np.load('F://第三篇//样本处理//CNN//2倍//input_4.npy')
input_5 = np.load('F://第三篇//样本处理//CNN//2倍//input_5.npy')
...
exp_1.to_csv("F://第三篇//样本处理//CNN//2倍//CNN_ALL_1.csv")
exp_2 = DataFrame(output_2)
exp_2.to_csv("F://第三篇//样本处理//CNN//2倍//CNN_ALL_2.csv")
exp_3 = DataFrame(output_3)
exp_3.to_csv("F://第三篇//样本处理//CNN//2倍//CNN_ALL_3.csv")
exp_4 = DataFrame(output_4)
exp_4.to_csv("F://第三篇//样本处理//CNN//2倍//CNN_ALL_4.csv")
exp_5 = DataFrame(output_5)
exp_5.to_csv("F://第三篇//样本处理//CNN//2倍//CNN_ALL_5.csv")
